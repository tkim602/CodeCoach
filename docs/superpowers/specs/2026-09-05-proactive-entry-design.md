...
- Offer `Write approach`, `Need a hint`, and `Hide` actions.
...
- Keep the inline coach visible through code edits and submission results until the learner selects `Hide` / `숨기기`.
