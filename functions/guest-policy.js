...
const GUEST_MAX_INPUT_BYTES = 55_000;
...
function maximumRequestCostMicroUsd() {
  // A tokenizer cannot emit more tokens than there are UTF-8 bytes in the supplied text.
  // Leave additional budget below $0.50 for request-envelope/model bookkeeping tokens.
  return calculateCostMicroUsd({
    inputTokens: GUEST_MAX_INPUT_BYTES,
